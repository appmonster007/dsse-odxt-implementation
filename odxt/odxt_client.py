...
if __name__ == "__main__":
    ...
    client_obj.Update('add', 9, "apple")
    client_obj.Update('add', 10, "apple")
    client_obj.Update('add', 11, "apple")
    client_obj.Update('add', 12, "apple")
    client_obj.Update('add', 13, "apple")
    client_obj.Update('add', 14, "apple")
    # client_obj.Update('add' 7, "apple")
